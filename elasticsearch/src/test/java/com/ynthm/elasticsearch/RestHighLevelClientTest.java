...
public class RestHighLevelClientTest {
    ...
    void testCluster() throws IOException {
        ...
        ClusterGetSettingsResponse response = highLevelClient.cluster().getSettings(request, RequestOptions.DEFAULT);
    ...
    void testDocument() throws IOException {
        ...
        IndexRequest indexRequest = new IndexRequest("article", "article")
                .source(jsonMap);
