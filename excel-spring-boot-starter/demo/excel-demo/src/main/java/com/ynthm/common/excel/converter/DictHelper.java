...
import com.ynthm.common.web.util.SpringBeanUtil;
...
public class DictHelper {
  ...
  private final DictService dictService = SpringBeanUtil.getBean(DictService.class);
  ...
  /**
   * 通过 {@link SpringBeanUtil} 获取注入到Spring 的服务
   *
