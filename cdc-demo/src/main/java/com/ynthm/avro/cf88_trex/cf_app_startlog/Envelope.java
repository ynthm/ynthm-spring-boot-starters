...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Envelope fromByteBuffer(
   ...
   private com.ynthm.avro.cf88_trex.cf_app_startlog.Value before;
   private com.ynthm.avro.cf88_trex.cf_app_startlog.Value after;
   ...
   */
  public Envelope(com.ynthm.avro.cf88_trex.cf_app_startlog.Value before, com.ynthm.avro.cf88_trex.cf_app_startlog.Value after, io.debezium.connector.mysql.Source source, java.lang.CharSequence op, java.lang.Long ts_ms, io.confluent.connect.avro.ConnectDefault transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (com.ynthm.avro.cf88_trex.cf_app_startlog.Value)value$; break;
    case 1: after = (com.ynthm.avro.cf88_trex.cf_app_startlog.Value)value$; break;
   ...
   */
  public com.ynthm.avro.cf88_trex.cf_app_startlog.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(com.ynthm.avro.cf88_trex.cf_app_startlog.Value value) {
    this.before = value;
  }
   ...
   */
  public com.ynthm.avro.cf88_trex.cf_app_startlog.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(com.ynthm.avro.cf88_trex.cf_app_startlog.Value value) {
    this.after = value;
  }
   ...
   */
  public static com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder newBuilder() {
    return new com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder newBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder other) {
    if (other == null) {
      return new com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder();
    } else {
      return new com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder newBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope other) {
    if (other == null) {
      return new com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder();
    } else {
      return new com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private com.ynthm.avro.cf88_trex.cf_app_startlog.Value before;
    private com.ynthm.avro.cf88_trex.cf_app_startlog.Value.Builder beforeBuilder;
    private com.ynthm.avro.cf88_trex.cf_app_startlog.Value after;
    private com.ynthm.avro.cf88_trex.cf_app_startlog.Value.Builder afterBuilder;
    private io.debezium.connector.mysql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = com.ynthm.avro.cf88_trex.cf_app_startlog.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = com.ynthm.avro.cf88_trex.cf_app_startlog.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setBefore(com.ynthm.avro.cf88_trex.cf_app_startlog.Value value) {
     ...
     * @return This builder.
     */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Value.newBuilder(before));
        } else {
          setBeforeBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Value.newBuilder());
        }
      }
    ...
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setBeforeBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setAfter(com.ynthm.avro.cf88_trex.cf_app_startlog.Value value) {
     ...
     * @return This builder.
     */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Value.newBuilder(after));
        } else {
          setAfterBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setAfterBuilder(com.ynthm.avro.cf88_trex.cf_app_startlog.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setSource(io.debezium.connector.mysql.Source value) {
    ...
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setSourceBuilder(io.debezium.connector.mysql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setOp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setTransaction(io.confluent.connect.avro.ConnectDefault value) {
    ...
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder setTransactionBuilder(io.confluent.connect.avro.ConnectDefault.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ynthm.avro.cf88_trex.cf_app_startlog.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (com.ynthm.avro.cf88_trex.cf_app_startlog.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (com.ynthm.avro.cf88_trex.cf_app_startlog.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new com.ynthm.avro.cf88_trex.cf_app_startlog.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new com.ynthm.avro.cf88_trex.cf_app_startlog.Value();
        }
